...
ADMIN_TRY_DELETE_CATEGORY_WHICH_IS_USED = 'Can not delete the category tag %s (%s) because it is in use on an active ' \
                                          'listing. Please update the tag on the listing and try again.'

# for colour type
ADMIN_COLOUR_ALREADY_EXISTS = 'Color with name %s already exists in subcategory %s (%s > %s)'
ADMIN_TRY_DELETE_COLOUR_WHICH_IS_USED = 'Can not delete the colour tag %s (%s > %s > %s) because it is in use on an ' \
                                        'active listing. Please update the tag on the listing and try again.'

# for conditiom type
ADMIN_CONDITION_ALREADY_EXISTS = 'Condition with name %s already exists in subcategory %s (%s > %s)'
ADMIN_TRY_DELETE_CONDITION_WHICH_IS_USED = 'Can not delete the condition tag %s (%s > %s > %s) because it is in use on ' \
                                           'an active listing. Please update the tag on the listing and try again.'

# for platform type
ADMIN_PLATFORM_ALREADY_EXISTS = 'Platform with name %s already exists'
ADMIN_TRY_DELETE_PLATFORM_WHICH_IS_USED = 'Can not delete the platform tag %s because it is in use on an active ' \
                                          'listing. Please update the tag on the listing and try again.'

# for subcategory type
ADMIN_SUBCATEGORY_ALREADY_EXISTS = 'Subcategory with name %s already exists in category %s (%s)'
ADMIN_TRY_DELETE_SUBCATEGORY_WHICH_IS_USED = 'Can not delete the subcategory tag %s (%s > %s) because it is in use on ' \
                                             'an active listing. Please update the tag on the listing and try again.'