...
SIGN_UP_EMPTY_AUTHORIZATION_DATA = 'You did not enter a mobile number'
...
LOG_IN_USER_NOT_FOUND = 'There is no user with mobile number %s. Please check the number or sign up.'
