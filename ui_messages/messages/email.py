...
ADMIN_CHANGE_USERTYPE_LETTER_TEXT = 'Congrats!\nYou were added to Hawkist %s user group. Go to %s  and use your email address ' \
                             'and this temporary password to log in administration tool:\n%s\nEnjoy!'
...
ADMIN_PHONE_NUMBER_CHANGED_LETTER_SUBJECT = 'Phone number changed'
