...
CONFIRM_EMAIL_LETTER_TEXT = '<b>%s</b>,<br/>' \
                            'To complete your Hawkist account we need you to confirm this email address.<br/>' \
                            'Please follow this link:<br/>' \
                            '%s/api/user/confirm_email/%s<br/>' \
                            'Thanks,<br/>' \
                            'Hawkist'

CONFIRM_SUCCESS_EMAIL_LETTER_SUBJECT = 'Hawkist Account is Ready'
CONFIRM_SUCCESS_EMAIL_LETTER_TEXT = "<b>%s</b>,<br/>" \
                                    "Thanks for confirming your email address. Your Hawkist account is now ready to go!<br/>" \
...
ADMIN_CHANGE_USERTYPE_LETTER_TEXT = 'Congrats!<br/>You were added to Hawkist %s user group. Go to %s and use your email ' \
...
ADMIN_ACCOUNT_ACTIVATED_TEXT = 'Dear <b>%s</b>,<br/>' \
                               'Your Hawkist account has been reactivated. Please contact Hawkist support on ' \
                               'info@hawkist.com if you have any other questions<br/>' \
                               'Thanks<br/>' \
                               'Hawkist Support'
...
PURCHASE_ITEM_BUYER_TEXT = u'<b>%s</b>,<br/>' \
                           ...
                           u'Thanks for your business!<br/>' \
                           u'Hawkist'

PURCHASE_ITEM_SELLER_TITLE = 'Sold: %s'
PURCHASE_ITEM_SELLER_TEXT = u"<b>%s</b>,<br/>" \
                            ...
                            u"you get the funds.<br/>" \
                            u"For more information about receiving funds after a purchase, please visit our FAQs on " \
                            u"https://hawkist.zendesk.com.<br/>" \
                            u"If you have any questions, you can contact Hawkist support on info@hawkist.com.<br/>" \
                            u"Thanks for your business!<br/>" \
                            u"Hawkist"

PURCHASE_ITEM_SELLER_TEXT_WITH_ADDRESS = u"<b>%s</b>,<br/>" \
                                         ...
                                         u"can be contacted via email on %s.<br/>" \
                                         u"His delivery address is %s.<br/>" \
...
LISTING_WITH_ISSUE_SELLER_TEXT = '<b>%s</b>,<br/>' \
                                 ...
                                 'FAQs on https://hawkist.zendesk.com.<br/>' \
                                 'If you have any questions, you can contact Hawkist support on info@hawkist.com.<br/>' \
                                 'Thanks for your business!<br/>' \
                                 'Hawkist'

LISTING_RECEIVED_SELLER_TITLE = 'Received: %s'
LISTING_RECEIVED_SELLER_TEXT = u"<b>%s</b>,<br/>" \
                               u"Your item <b>%s</b> has been marked received by <b>%s</b>. We have now released the " \
                               u"funds for this order into your Hawkist wallet.<br/>" \
                               u"Please note that Hawkist charges a fee for successful transactions so you will " \
                               u"be receiving <b>£%s</b>.<br/>" \
...
LISTING_WITH_ISSUE_INVESTIGATION_OPENED_TEXT = "<b>%s</b>,<br/>" \
                                               ...
                                               "will not do so until the investigation completed.<br/>" \
                                               "For more information about how Hawkist investigates issues with " \
                                               "purchases, please visit our FAQs on https://hawkist.zendesk.com.<br/>" \
...
FUNDS_RECEIVED_SELLER_TEXT = u"<b>%s</b>,<br/>" \
                             u"We have now released the funds for your item <b>%s</b> into your Hawkist wallet.<br/>" \
                             u"Please note that Hawkist charges a fee for successful transactions so you will be " \
                             u"receiving <b>£%s</b>.<br/>" \
                             u"For more information about our charges, please visit our FAQs on " \
                             u"https://hawkist.zendesk.com.<br/>" \
                             u"If you have any questions, you can contact Hawkist support on info@hawkist.com.<br/>" \
                             u"Thanks for your business!<br/>" \
...
INVESTIGATION_RESOLVED_TEXT = '<b>%s</b>,<br/>' \
                              'After conducting a thorough investigation into the issues on <b>%s</b> we have decided ' \
                              'that the order will proceed.<br/>' \
                              'Please note that funds will not be refunded.<br/>' \
                              'For more information about how Hawkist investigates issues with purchases, please visit ' \
                              'our FAQs on https://hawkist.zendesk.com.<br/>' \
                              'If you have any questions, you can contact Hawkist support on info@hawkist.com.<br/>' \
                              'Thanks for your business!<br/>' \
                              'Hawkist'

HAS_ITEM_RECEIVED_TITLE = 'Update Required: %s'
HAS_ITEM_RECEIVED_TEXT = '<b>%s</b>,<br/>' \
                         'It has been <b>%s</b> days since you purchased <b>%s</b>. Has the item arrived yet?<br/>' \
                         'If so please log on to Hawkist and let us know. We need an update so the payment for this ' \
                         'purchase can be released to the seller.<br/>' \
...
WITHDRAWAL_REQUESTED_TEXT = u'<b>%s</b>,<br/>' \
                            u'We have received your request to withdraw <b>£%s</b> from your Hawkist account. We will ' \
                            u'contact you once the money has been transferred to your bank account.<br/>' \
